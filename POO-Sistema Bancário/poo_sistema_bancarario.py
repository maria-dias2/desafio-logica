        ...
        self._transacoes.append(
            {
                ...
                #lc"data": datetime.now().strftime("%d-%m-%Y %H:%M:%s"),
            }
        )
...
def depositar(clientes):
    cpf = input("Ingforme o CPF do cliente: ")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("XXX Opção inválida, por favor selecione novamente a operação desejada. XXX")
